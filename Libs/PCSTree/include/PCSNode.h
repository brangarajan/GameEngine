...
private:
   ...
   int privateCheckLength(int n) const;
   int privateCheckBuffer(int n) const;
   void privatePrintParent() const;
   void privatePrintChild() const;
   void privatePrintSibling() const;
   void privatePrint (PCSNode *node) const;
   int privateGetNum(PCSNode * node) const;
};
